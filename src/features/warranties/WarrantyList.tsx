    ...
    return (
        <Box sx={{mt: 4}}>
                                            ...
                                            {canManage && (
                                                <>
                                                    ...
                                                    <Button size="small" color="error"
                                                            onClick={() => handleOpenDelete(warranty.publicId)}>
                                                        Sil
                                                    </Button>
                                                </>
                                            )}
            ...
            <Dialog open={isDeleteDialogOpen} onClose={() => setIsDeleteDialogOpen(false)} maxWidth="xs" fullWidth>
                ...
                <DialogContent>
                    <Typography>Seçili garanti kaydını silmek istediğinize emin misiniz? Bu işlem geri
                        alınamaz.</Typography>
                </DialogContent>
                <DialogActions>
                    <Button
